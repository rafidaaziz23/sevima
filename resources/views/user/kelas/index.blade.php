      ...
      <div>
         ...
         <div class="d-flex align-items-center">
            ...
            <div class="d-flex flex-column flex-grow-1">
               <a href="#" class="text-dark-75 text-hover-primary mb-1 font-size-lg font-weight-bolder">Rafida Aziz</a>
         ...
         <div>
            <!--begin::Text-->
            <p class="text-dark-75 font-size-lg font-weight-normal pt-5 mb-2">Lorem ipsum dolor sit amet corrupti quis, hic iure ea natus laudantium totam repellat quam pariatur doloremque saepe. Obcaecati, cumque beatae.</p>
            <!--end::Text-->
            <!--begin::Action-->
            <div class="d-flex align-items-center">
